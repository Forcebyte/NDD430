...
#- Scenerio 2 -#  
#Configures your firewall to be able to connect to only the following services...
	# DHCP
	# DNS
	# SSH To the Router
	# IIS Web Server
...
# we can now deny all other traffic unrelated at the INBOUND sector (E.g. incoming from Winserv or Lnxserv)
